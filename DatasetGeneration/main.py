...
def generateQueries(table,numquery):
    ...
    while (len(queries)!= numquery):
        ...
        if(i == 1): #Generate random query of length 1
            ...
            query =q_id+', '+ header[h1] + '=' + str(randomRow[h1]) + ', ' + header[h2] + '=' + str(randomRow[h2])+ ', ' + header[h3] + '=' + str(randomRow[h3])
            pass
            ...
            query = q_id +', ' + header[h1] + '=' + str(randomRow[h1]) + ', ' + header[h2] + '=' + str(randomRow[h2]) + ', ' + header[h3] + '=' + str(randomRow[h3]) + ', ' + header[h4] + '=' + str(randomRow[h4])
            pass
